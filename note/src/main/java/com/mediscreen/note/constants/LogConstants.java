...
public class LogConstants {
    public static final String GET_ALL_NOTES_BY_PAGE_REQUEST_RECEIVED = "GET /note/list request received on ms-note";
    ...
    public static final String GET_ALL_NOTES_FOR_PATIENT_SERVICE_CALL =
        "NoteService.getAllNotesForPatient request received on ms-note";
    public static final String GET_ALL_NOTES_FOR_PATIENT_OK = "List of medical notes retrieved \n";
